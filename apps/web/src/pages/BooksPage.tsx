...
export function BooksPage() {
  ...
  const [genreId, setGenreId] = useState<string | null>(params.get('genre'))
  ...
  const isBrowsing =
    debouncedSearch.trim() === '' && genreId === null && availability === 'all'
  ...
  return (
    <AppShell>
      <header className="page-head">
        <div>
          <h1 className="page-head__title">Books</h1>
